...
/** @var array $scheduleImage */
/** @var array $sliderImages */
            ...
            <div id="register">
                ...
                <?php if ($showSuccess): ?>
                    ...
                    <div class="success-card">
                        ...
                        <h2 class="class-schedule-title">Class Schedule</h2>

                        <!-- <div class="zoom-logo">
                            <img src="assets/images/zoom-logo.png" alt="Zoom">
                        ...
                        <!-- ── FEATURED VIDEO ── -->
                        <div class="action-divider"><span>🎬 Featured Class</span></div>

                        <div class="featured-video-wrap">
                            <video controls preload="metadata" playsinline>
                                <source src="https://s3-np1.datahub.com.np/class-videos/videos/2026/vid_187/original.mp4" type="video/mp4">
                        ...
                        <!-- Full social grid -->
                        <div class="social-grid common-content">
                            ...
                            <a href="https://www.instagram.com/cee_rankfactory/" target="_blank" rel="noopener" class="nudge-btn s-instagram">
                                <svg viewBox="0 0 24 24" fill="currentColor" width="16" height="16">
                        ...
                        <div class="app-buttons common-content">
                        ...
                        <!-- ── LOGIN CREDENTIALS ── -->
                        <div class="login-info-card common-content">
